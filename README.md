# Zeitlog core (pre-production)

The **pre-production** copy of [Zeitlog core](https://github.com/zeitlog/core) — sleep-diary format engines with Fitbit and Google Health import. A fork of [sleepdiary/core](https://github.com/sleepdiary/core), and the source of upstream PR [sleepdiary/core#52](https://github.com/sleepdiary/core/pull/52).

Production lives at [zeitlog/core](https://github.com/zeitlog/core); this fork feeds the pre-production tracker at <https://wellivea1.github.io/dashboard-vibecode/>.
